...
import { BookUser, FilePen, LayoutDashboard, Reply, Send, TabletSmartphoneIcon, Users, CreditCard, Key } from "lucide-react"
        ...
        <Sidebar collapsible="offcanvas" {...props}>
            ...
            <SidebarContent>
                <SidebarMenu className="px-2 py-4 gap-y-2">
                    ...
                    <SidebarMenuItem>
                        <SidebarMenuButton isActive={pathname.startsWith('/group-extraction')} size="lg">
                            <Link href="/group-extraction" className="flex items-center gap-3">
                                <div className="flex h-9 w-9 items-center justify-center rounded-md bg-primary/10">
                                    <Users />
                                </div>
                    ...
                    <SidebarMenuItem>
                        <SidebarMenuButton isActive={pathname.startsWith('/settings/api-keys')} size="lg">
                            <Link href="/settings/api-keys" className="flex items-center gap-3">
                                <div className="flex h-9 w-9 items-center justify-center rounded-md bg-primary/10">
                                    <Key />
                                </div>
