...
export default async function Devices() {
    ...
    const messagesSent = devices.reduce((acc, device) => acc + device.messagesSent, 0);
    ...
    const remainingMessages = userData?.plan ? userData.plan.messageLimit! - messagesSent : 0;
    return (
                ...
                <header className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <Card className="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p className="text-4xl font-bold ">{allContacts}</p>
                        </div>
                    </Card>
                    ...
                    <Card className="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p className="text-base font-semibold">{remainingMessages} messages remaining</p>
                        </div>
                    </Card>
                </header>
                    ...
                    <Card>
                        ...
                        <div className="flex flex-col p-4 sm:flex-row justify-between items-start sm:items-center mb-4">
                            <div className="mb-4 sm:mb-0">
                                ...
                                <p className="text-orange-500 text-sm">*You have {userData?.plan?.devicesLimit} devices limit</p>
                            </div>
                            <AddDeviceModal />
                        </div>
