...
import { ApiKeyService, CreateApiKeyInput, UpdateApiKeyInput, ApiKeyWithSecret } from "@/lib/api-keys";
            ...
            <div className="flex justify-between items-center mb-6">
                <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                        Manage API keys for programmatic access. Use them in requests with <code>Authorization: Bearer &lt;key&gt;</code>.
                    </p>
                    <p className="text-xs text-muted-foreground mt-2">
                        Keys are only shown once at creation. If you lose a key, create a new one and revoke the old one.
                    </p>
                </div>
